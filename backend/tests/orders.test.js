...
describe('Order Controller Tests', () => {
  ...
  describe('getOrderByOrderId', () => {
    ...
    test('returns 200 with order and items if found', async () => {
      req.params.orderId = '1';
      const mockOrder = { id: 1, user_id: 2, total_price: 100 };
      const mockItems = [
        { order_item_id: 10, product_id: 5, variant_id: 3, quantity: 2, unit_price: 50, product_name: 'Hair Straightener' }
      ];
